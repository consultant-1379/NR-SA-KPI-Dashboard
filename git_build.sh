...
function setRstate {
	...
	mv NR-SA-KPI-Dashboard/build/feature-release.xml NR-SA-KPI-Dashboard/build/feature-release.${rstate}.xml
...
if [ $rsp == 0 ]; then
  ...
  git remote set-url --push origin ssh://esjkadm100@gerrit.ericsson.se:29418/OSS/ENIQ-CR-Parent/OSS/com.ericsson.eniq/NR-SA-KPI-Dashboard
